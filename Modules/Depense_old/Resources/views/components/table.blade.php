                  ...
                  <div class="btn-group">
                      ...
                      <div class="dropdown-menu dropdown-menu-end fixed-top">
                         ...
                         <div class="dropdown-divider"></div>
                              <button class="dropdown-item btn-edit-facture" 
                                  class="cd-popup-trigger btn btn-info"wire:click="openUpdateDepenseModal({{ $depense->id }}, '{{$depense->type}}')"
                                  
                                  {{-- onclick="openpopup('factureComPopup')" --}}>
                                  <i class="fa fa-edit"></i> {{__('messages.edit')}}
                              </button>
                              <button class="dropdown-item btn-edit-recu" 
                                  class="cd-popup-trigger btn btn-success"
                                 
                                  {{-- onclick="openpopup('recuPopup')" --}}>
                                  <i class="fa fa-edit"></i> {{__('messages.pay')}}
                              </button>
